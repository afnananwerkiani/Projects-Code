...
public class Layers extends Button{
    ...
    public Layers() {
        super(600, 200, 200, 600, Color.BLACK, Color.GRAY);
        add = new Button(620,700,60,60,Color.BLACK,Color.GRAY,"Add");
        remove = new Button(700,700,60,60,Color.BLACK,Color.GRAY,"Remove");
        add();
    }
    ...
    public void remove(Layer layer){
        ...
        {
            System.out.println("Can not Remove This Layer");
        }
    }
